...
@synthesize namaRestoString, alamatRestoString, ratingRestoString, GambarString, resto_gambar, namaresto, ratingresto, alamatresto, btnRateOutlet, btnsegmentoutlet, distRestoString, distresto;
@synthesize long_val, lat_val;
@synthesize userlat, userlong;

//kopas dari CenterPage.h
@synthesize restolong, restodistance, restolat, restoarray, restoIdArray, restojalan, avgrating;
...
- (void)viewDidLoad
{
    ...
    [distresto setText:distRestoString];
