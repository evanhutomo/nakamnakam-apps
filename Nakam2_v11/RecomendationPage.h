...
@interface RecomendationPage : UIViewController <UINavigationBarDelegate, UITableViewDataSource, UITableViewDelegate, CLLocationManagerDelegate>
{
...
@property (nonatomic,strong) NSString *tampungpricerange;
