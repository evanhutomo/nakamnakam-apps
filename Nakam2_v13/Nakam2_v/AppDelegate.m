...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //custom title navbar
    [[UINavigationBar appearance] setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor colorWithRed:245.0/255.0 green:245.0/255.0 blue:245.0/255.0 alpha:1.0], UITextAttributeTextColor, [UIFont fontWithName:@"HelveticaNeue-CondensedBlack" size:24.0], UITextAttributeFont, nil]];
    ...
    OpsiPage *opsipage = [[OpsiPage alloc] initWithNibName:@"OpsiPage" bundle:nil];
    ...
    IIViewDeckController *deckkontrol = [[IIViewDeckController alloc] initWithCenterViewController:self.centerPage leftViewController:self.leftPage rightViewController:rightdetails topViewController:opsipage bottomViewController:nil];
