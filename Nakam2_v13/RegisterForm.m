        ...
        [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject)
         {
             ...
             if ([id_pembanding isEqualToString:@"ada_yang_sama"]) {
                 ...
                 if (tampung == NULL) {
                     ...
                     [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject)
                      {
                          SIAlertView *alert = [[SIAlertView alloc] initWithTitle:@"Selamat!" andMessage:@"Anda sudah terdaftar di NakamNakam. Sebelum menggunakan layanan kami, silahkan cek email anda untuk aktifasi akun anda :)"];
                          [alert addButtonWithTitle:@"Ok"
                                               type:SIAlertViewButtonTypeCancel
                                            handler:nil];
                          alert.transitionStyle = SIAlertViewTransitionStyleSlideFromBottom;
                      ...
                      {
                          SIAlertView *alert = [[SIAlertView alloc] initWithTitle:@"Maaf" andMessage:@"Ada Masalah dalam koneksi internet"];
                          [alert addButtonWithTitle:@"Ok"
                                               type:SIAlertViewButtonTypeCancel
                                            handler:nil];
                          alert.transitionStyle = SIAlertViewTransitionStyleSlideFromBottom;
