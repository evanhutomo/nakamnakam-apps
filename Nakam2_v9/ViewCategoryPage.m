...
@interface ViewCategoryPage () <UITableViewDelegate, UITableViewDataSource,IIViewDeckControllerDelegate>

@end

@implementation ViewCategoryPage
...
//    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"menu" style:UIBarButtonItemStyleBordered target:self.viewDeckController action:@selector(toggleLeftView)];
    ...
    NSMutableURLRequest *request = [httpClient requestWithMethod:@"GET"
                                                            path:[NSString stringWithFormat:@"http://nakamnakam.com/evan/index.php?format=%@", tampungkategori]
                                                      parameters:nil];
